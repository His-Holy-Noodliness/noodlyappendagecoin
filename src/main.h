...
static const int64 DUST_SOFT_LIMIT = 100000; // 0.001 NDL
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64 DUST_HARD_LIMIT = 1000;   // 0.00001 NDL mininput
/** No amount larger than this (in satoshi) is valid */
static const int64 MAX_MONEY = 13798000000 * COIN; // 13.798 Billion NDL, one for every year since the first touch of His Noodly Appendage
static const int64 TOTAL_GENERATION = MAX_MONEY;
static const double FSM_FUNDS = 0.03;
inline bool MoneyRange(int64 nValue) { return (nValue >= 0 && nValue <= MAX_MONEY); }
/** Mined coins are spendable after 60 blocks (Approximately an hour) */
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 1440 / 250; // NDL: 1440 blocks per day, 250 byte transactions
    }
