...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Noodlyappendagecoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"noodlyappendagecoin.com", "ndlseed.noodlyappendagecoin.com"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"testseed.noodlyappendagecoin.com", "testseed.noodlyappendagecoin.com"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Noodlyappendagecoin is probably already running."), addrBind.ToString().c_str());
        else
